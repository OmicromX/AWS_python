#Una función recibe parámetros o variables para realizar una tarea específica

#Creamos una función llamada suma
def suma(numero1, numero2):
    #Guardamos ña variable resultado el valor de la suma
...
#Convertimos la variable a número
a = int(a)

#Creamos una variable a con lo que diga el usuario
b = input("Escriba un número: ")
#Convertimos la variable b número
b = int(b)
