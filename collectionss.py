...
# imprimimos el primer valro de la tupla que es "Apple"
print(myFinalAnswerTuple[0])

# imprimimos el seguno valro de la tupla que es "bannana"
print(myFinalAnswerTuple[1])

# imprimimos el tercer valro de la tupla que es "Pineapple"
...
# Imprimos el diccionario completo
