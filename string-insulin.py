# Guardamos la secuencia completa de la insulina
...
# Aquí calculo el peso molecular de la insulina
molecularWeightInsulin = 0

for x in aaCountInsulin:
    molecularWeightInsulin += aaCountInsulin[x] * aaWeights[x]

# Muestro el peso molecular aproximado.
# Uso str() porque no puedo juntar texto con número directamente.
print("El peso molecular aproximado de la insulina es: " + str(molecularWeightInsulin))
